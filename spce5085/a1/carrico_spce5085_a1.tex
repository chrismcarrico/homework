...
$ r_a = R_{Earth} + apogee\ altitude = 6378.137\ km + 5000\ km = 11378.136\ km $ \\
$ r_p = R_{Earth} + perigee\ altitude = 6378.137\ km + 800\ km = 7178.137\ km $ \\
...
\solution{
  ...
  $elevation\ angle = \tan^{-1}(\frac{6.61073 - \cos(\gamma)}{\sin(\gamma)}) - \gamma$, where $6.61073 = \frac{R_{GEO}}{R_{Earth}}$ \\
  $intermediate\ angle = \tan^{-1}(\frac{\tan(|lon_{satellite} - lon_{earth}|)}{\sin(lat_{earth})})$ \\
...
\solution{
\ans{elevation = 37.474\degree, azimuth = 137.993\degree}
}
...
\solution{
\ans{elevation = 37.067\degree, azimuth = 180.00\degree}
}
...
\solution{
\ans{elevation = 49.307\degree, azimuth = 195.814\degree}
}
...
\solution{
  ...
  Rio de Janeiro, Brazil: \ans{elevation = 59.3264\degree, azimuth = 328.9903\degree} \\
  Santiago, Chile: \ans{elevation = 31.8804\degree, azimuth = 302.6809\degree}
}
...
\solution{At beginning of life, if one solar sail fails, the total power generated is 4 kW. \\
