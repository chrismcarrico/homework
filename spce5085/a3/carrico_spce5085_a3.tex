...
\solution{Spreadsheet is submitted separately.}
\subproblem{a}{Is the selection of QPSK at 1/2 rate an appropriate choice? explain}
\solution{Yes the selection of QPSK at 1/2 rate is appropriate with a CNR of 14 dB and achieves a BER of $\approx 10^{-7}$. The 1/2 rate is a good choice for a broadcast application because it provides uninterrupted transmission at the tradeoff of a lower bandwidth.}
\subproblem{b}{What would be the CNR and link margin be, if the Transponder was 170 W (vs. 160 W as in table)}
\solution{By increasing the Transponder transmission power to 170 W or $10\log_{10}(170) = 22.3$ dB, the CNR would increase to $15.8$ dB and the link margin would increase to $7.5$ dB.}
